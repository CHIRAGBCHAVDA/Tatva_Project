  ...
  return (
    <div>
      <React.Fragment>
        ...
        {/* <Box sx={{ bgcolor: "#E6E6FA", height: "30vh" }}  />
        <img
...
<Box sx={{ bgcolor: "#E6E6FA", height: "30vh", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column" }}>
  ...
  <p style={{ marginTop: "10px", font:"10px", color:"gray" }}>&copy; 2015 Tatvasoft.com. All Rights Reserved</p>
</Box>
